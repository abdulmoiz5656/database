    ...
    def SEARCH_PAT(self):
        ...
        if (len(p) == 0):
            ...
            for i in t:
                ...
                self.l9 = Label(self.LoginFrame, text="CONTACT NUMBER", font="Helvetica 14 bold", bg="cadet blue",
                                bd=22)
                ...
                self.l10 = Label(self.LoginFrame, text="ALTERNATE CONTACT", font="Helvetica 14 bold", bg="cadet blue",
                                 bd=22)
